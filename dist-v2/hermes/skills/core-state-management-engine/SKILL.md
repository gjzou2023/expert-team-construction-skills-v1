...
description: 维护阶段决策快照，处理用户回退、平台更换和长对话上下文压缩。 Use when: 用户说"core-state-management-engine、状态管理引擎、L0状态"等触发词。
version: 1.1.0
...
> **层级**: L0 | **版本**: 1.1.0 | **ID**: `core-state-management-engine` | **中文名**: 状态管理引擎 | **英文名**: State Management Engine
