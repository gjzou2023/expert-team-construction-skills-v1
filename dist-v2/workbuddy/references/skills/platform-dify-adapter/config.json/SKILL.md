{
  ...
  "few_shot_examples": [
    {
      ...
      "output": {
        "status": "completed",
        "decision": "Dify平台适配器已按A型内容传播场景执行",
  ...
  "knowledge_base_mount_points": [
    {
      "type": "static",
      "path": "file://platform/platform-dify-adapter/format-spec",
      "description": "Dify平台适配器格式规范"
    },
    {
      "type": "dynamic",
      "path": "file://runtime/platform-dify-adapter/state",
      "description": "运行时状态、用户确认和阶段快照"
    },
    {
      "type": "rag",
      "path": "file://rag/platform-dify-adapter/references",
  ...
  "execution_logic": "目标平台=Dify平台适配器时激活。输出格式：Dify Workflow配置 + Schedule Trigger定义。平台特定规则：使用Dify Workflow的Schedule Trigger;独立映射表。",
  "cascading_calls": [
    "core-mental-model-engine"
  ],
  "context_inheritance": [
