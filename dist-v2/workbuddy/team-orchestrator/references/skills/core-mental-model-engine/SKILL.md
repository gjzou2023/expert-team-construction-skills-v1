...
description: 根据当前决策场景，从18个心智模型中选择匹配模型，输出结构化推理链。v1.4.0场景映射扩展至9场景(user_interaction/industry_adaptation/conflict_resolution) Use when: 用户说"core-mental-model-engine、心智模型引擎、L0推理引擎"等触发词。
---

# 思维框架引擎

> **层级**: L0 | **版本**: 1.4.0 | **ID**: `core-mental-model-engine` | **中文名**: 思维框架引擎 | **英文名**: Mental Model Engine
