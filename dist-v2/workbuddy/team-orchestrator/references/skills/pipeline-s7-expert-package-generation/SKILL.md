...
description: 生成专家包概览、按目标平台格式生成配置、嵌入全局机制、生成执行计划、四步确认门。v1.4.0新增快速通道字段回填机制、展示格式弹性规则，整合确认步骤。字段追踪强制。按需条件激活L2协议和L3适配器 Use when: 用户说"S7执行、专家包生成、四步确认门、平台配置生成、专家包导出"等触发词。
---
