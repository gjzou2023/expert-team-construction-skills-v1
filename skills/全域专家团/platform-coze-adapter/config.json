{
  ...
  "few_shot_examples": [
    {
      ...
      "output": {
        "status": "completed",
        "decision": "Coze平台适配器已按A型内容传播场景执行",
  ...
  "knowledge_base_mount_points": [
    {
      "type": "static",
      "path": "file://platform/platform-coze-adapter/format-spec",
      "description": "Coze平台适配器格式规范"
    },
    {
      "type": "dynamic",
      "path": "file://runtime/platform-coze-adapter/state",
      "description": "运行时状态、用户确认和阶段快照"
    },
    {
      "type": "rag",
      "path": "file://rag/platform-coze-adapter/references",
  ...
  "execution_logic": "目标平台=Coze平台适配器时激活。输出格式：Coze Bot配置 + 工作流定义。平台特定规则：Token限制;使用Coze工作流的定时/Webhook触发器。",
  "cascading_calls": [
    "core-mental-model-engine"
  ],
  "context_inheritance": [
